...
<table width="800" align="center">
	...
	<tr>
		...
		<table width="300" align="center">
			<tr>
				<td align="center" bgcolor="gray" width="150">id</td>
				<td><input type="text" name="id" size="25"></td>
			</tr>
			<tr>
				<td align="center" bgcolor="gray">name</td>
			...
			<tr>
				<td align="center" bgcolor="gray">re</td>
				<td><input type="password" name="re" size="25"></td>
			</tr>
			<tr>
