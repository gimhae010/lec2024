...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
    	...
    	<li class="active"><a href="./login/login.do">LOGIN</a></li>
    </ul>
  </div>
</nav>
	<div class="container">
		<div id="content" class="row">
			...
			<form method="post">
				<div class="form-group">
					<label></label><input name="" class="form-control"/>
				</div>
				<div class="form-group">
					<label></label><input name="" class="form-control"/>
				</div>
				<div class="form-group">
					...
					<a href="join.do" role="button" class="btn btn-default btn-block">회원가입</a>
				</div>
			</form>
			<!-- content end-->
			</div>
